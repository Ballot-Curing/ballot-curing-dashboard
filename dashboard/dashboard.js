...
function render_election_data(state, election_dt) {
  ...
  $.ajax({
    ...
    success: function (result, status, xhr) {
      ...
      make_bar_chart(stats_data.total_age_group, stats_data.rejected_age_group, "age_count", "age", "% Rejected Ballots By Age Group", "age_group")
      ...
      make_bar_chart(stats_data.total_race, stats_data.rejected_race, "race_count", "race", "% Rejected Ballots By Race", "race_group")
      ...
      make_bar_chart(stats_data.total_gender, stats_data.rejected_gender, "gender_count", "gender", "% Rejected Ballots By Gender", "gender_group")
